...
if __name__ == "__main__":
    ...
    for param in params:
        ...
        with open("{}_dynamics_closed".format(param),"rb") as file:
            times,data = pickle.load(file)
        with open("{}_dynamics_RWA_closed".format(param),"rb") as file:
        ...
        with open("{}_dynamics".format(param),"rb") as file:
            times,data = pickle.load(file)
        with open("{}_dynamics_RWA".format(param),"rb") as file:
            times,RWA_data = pickle.load(file)
